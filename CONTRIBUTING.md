...
Lumina is community-built. Every merged pull request, reported bug, and piece of documentation makes a real difference. This guide will help you understand how to contribute effectively, regardless of your skill level.

---

## Table of Contents

- [Contributing to Lumina](#contributing-to-Lumina)
...
# Add upstream remote
git remote add upstream https://github.com/your-org/Lumina.git
...
1. Browse [open issues](https://github.com/your-org/Lumina/issues)
