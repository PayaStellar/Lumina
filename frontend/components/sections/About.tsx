...
export function About() {
  return (
    <Section
      ...
      description="Lumina is an open-source payment infrastructure for businesses and developers. Collect payments in multiple cryptocurrencies, settle as USDC on Stellar via Soroban smart contracts, and plug into dashboards, webhooks, and SDKs."
    >
